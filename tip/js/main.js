...
var tipsList = [
	"Don't forget the xx<span class='code'>var yy </span>  zz keyword when assigning a variable's value for the first time.",
	...
	"To interpolwwwwqwate a variable into a string, use the <span class='code'>+</span> operator, like this: <br> <span class='code-block'>var myName = 'Jon';<br/> 'Hello, my name is ' + myName;</span>",
